...
// Reusable contact form + contact info section, used on the Home page
// (above the footer) and on the standalone Contact page.
export default function ContactSection({ showImage = false }) {
  const { t } = useLanguage();
